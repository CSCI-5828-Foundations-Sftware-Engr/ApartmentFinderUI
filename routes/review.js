                ...
                if(reviewResult){
                    ...
                    newReview.save().then((savedReview =>{
                        if(savedReview){
                            ...
                            reviewAnalysis.findOne({propertyId:req.body.propertyId}).then((reviewData =>{
                                ...
                                if(!(reviewData == null)){
                                    ...
                                    if(analysis >0){
                                        ...
                                        const positve = reviewData.positve+1;
                                          reviewAnalysis.updateOne({propertyId:req.body.propertyId}, {
                                            ...
                                            console.log(err);
                                            res.status(404);
                                            return res.send({message: "Unable to save new review"});
                                          })
                                ...
                                //If review doesnt exist for the property, add a new entry with initial values
                                    ...
                                    if(analysis >0){
                                        ...
                                        const newReviewAnalysis = new reviewAnalysis({
                                          ...
                                          newReviewAnalysis.save().then((savedReview =>{
                                            console.log(savedReview);
                                            return res.status(200).send({message: "New review saved"});
                                        })).catch(err =>{
                                            console.log(err);
                                            res.status(404);
                                            return res.send({message: "Unable to save new review"});
